...
import 'package:school/controller/student/lesson_content/test_result_controller.dart';
          ...
          builder: (controller) => HandlingDataRequest(
            ...
            widget: Padding(
                ...
                child: ListView(
                  ...
                  children: [
                    Center(
                      child: Text(' ${controller.examResult?.exam?.nameQuize1}',
                        ...
                        children: [
                          ...
                          Text(
                              "${controller.examResult?.studentResult}" +
                                  ...
                                  "/" +
                                  " " +
                                 "${controller.examResult?.exam!.successMark}",
                              style: Theme.of(context)
                                  .textTheme
                                  .bodySmall!
                                  .copyWith(
                    ...
                    GetBuilder<TestResultController>(
                      builder: (controller) {
