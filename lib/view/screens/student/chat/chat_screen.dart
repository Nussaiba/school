...
import 'package:school/view/widgets/chat_widget/text_field.dart';
        ...
        appBar: AppBar(
          ...
          title: Row(
            children: [
              ...
              Text("${chatController.teacher.firstName} ${chatController.teacher.lastName}",
...
Spacer(),
        ...
        body: Container(
          ...
          child: GetBuilder<GetMessageController>(
