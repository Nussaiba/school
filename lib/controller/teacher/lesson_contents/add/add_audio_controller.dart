...
class AddAudioDetailsTeacherController extends GetxController {
  ...
  void showAudioUploadDialog() {
    showDialog(
      context: Get.context!,
      builder: (context) {
        return AlertDialog(
          title: Center(
            child: Text('إضافة ملف صوتي جديد',
          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                GetBuilder<AddAudioDetailsTeacherController>(
